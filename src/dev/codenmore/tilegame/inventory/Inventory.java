...
public class Inventory {
	...
	public Inventory(Handler handler){
		...
		addItem(Item.herbItem);
		addItem(Item.herbItem);
		addItem(Item.herbItem);
		
		addItem(Item.magicTear);
		addItem(Item.magicTear);
		addItem(Item.magicTear);

		addItem(Item.attBerry);
		addItem(Item.defBerry);
		addItem(Item.hpBerry);
		addItem(Item.mpBerry);
